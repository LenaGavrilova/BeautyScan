TODO:
Алгоритм Левенштейна(выбрать лучший параметр расстояния)
Алгоритм комплексной оценки(добавить штрафы за большое количество неизвестных ингредиентов)
Доработать фронт админки
Добавить в анализ вывод информации из таблиц categories,effectiveness
